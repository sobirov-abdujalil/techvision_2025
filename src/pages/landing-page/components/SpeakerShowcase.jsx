  ...
  const speakers = [
    {
      ...
      description: "Sarah leads Meta's technology vision, overseeing AI research and implementation across 3+ billion users. Former Google DeepMind researcher with 15+ years in machine learning.",
      achievements: [
    ...
    },
    {
      ...
      description: "Marcus built and sold 3 successful startups, now invests in early-stage tech companies. Portfolio includes 12 unicorns with combined valuation of $50B+.",
      achievements: [
    ...
    },
    {
      ...
      description: "Dr. Patel leads IBM's quantum computing research, developing practical applications for enterprise use. PhD in Quantum Physics from MIT, 20+ years in quantum research.",
      achievements: [
    ...
    },
    {
      ...
      description: "Alex oversees Stripe's engineering organization, managing systems that process $800B+ annually. Expert in building resilient, scalable financial systems.",
      achievements: [
    ...
    },
    {
      ...
      description: "Jennifer protects internet infrastructure serving 25+ million domains. Former NSA cybersecurity analyst with expertise in nation-state threat detection.",
      achievements: [
    ...
    },
    {
      ...
      description: "David shapes how 100M+ developers build software on GitHub. Expert in developer productivity, open source ecosystems, and AI-assisted coding.",
      achievements: [
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-6xl font-headline-bold text-foreground mb-6">
            Learn from <span className="text-gradient-primary">Industry Pioneers</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Get insights from technology leaders who are shaping the future. 
            Each speaker brings decades of experience and exclusive industry knowledge.
          </p>
        </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      <h6 className="font-medium text-foreground mb-3">Session Info</h6>
                    ...
                    <div>
                      <h6 className="font-medium text-foreground mb-3">Key Takeaways</h6>
                      <ul className="space-y-2 text-sm text-muted-foreground">
                        {selectedSpeaker?.sessionDetails?.takeaways?.map((takeaway, index) => (
